...
const AddEducation = ({addEducation, history}) => {
  ...
  return (
    <Fragment>
      ...
      <p className='lead'>
        <i className='fas fa-code-branch'></i> Add any school or bootcamp you have attendedt
      </p>
      ...
      <form className='form' onSubmit={e=>{
        ...
        <div className='form-group'>
          <p>
            <input type='checkbox' name='current' checked={current} value={current} onChange={()=>{setFormData({...formData, current: !current})}} />{' '} Current place of Education
          </p>
        </div>
        <div className='form-group'>
          <h4>To Date</h4>
