...
// @route   DELETE api/posts/comment/:id/:id_comment
// @desc    Delete comment on a post
// @access   Private
router.delete("/comment/:id/:id_comment", auth, async (req, res) => {
  try {
    const post = await Post.findById(req.params.id);
    //Pull out comment
